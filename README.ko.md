...
먼저 Homebrew에서 변경 사항을 확인합니다. 확인 창의 **Current / New** 열에서 기존 버전과 새 버전을 비교할 수 있으며, 함께 변경되는 의존성도 표시됩니다. 새로 설치할 의존성의 Current에는 **Not installed**가 표시됩니다. 목록을 확인한 뒤 **Update**를 누르면 시작합니다.
